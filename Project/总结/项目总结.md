...
- 启动三步：kmssconfig.properties、sys\common\hebernate、tomcat

- tomcat参数：-Xms256m -Xmx1536m -XX:MetaspaceSize=128M -XX:MaxMetaspaceSize=512M -Xmn128M -Djava.awt.headless=true -Djava.net.preferIPv4Stack=true
